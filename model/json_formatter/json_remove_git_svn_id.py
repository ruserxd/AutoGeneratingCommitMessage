...
def process_json_data(data):
  ...
  if isinstance(data, dict):
    ...
    return remove_git_svn_id(data)
  else:
    return data


def main():
  parser = argparse.ArgumentParser(description='移除 JSON 中的 git-svn-id')
